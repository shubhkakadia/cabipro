        ...
        <div className="mx-auto max-w-2xl w-full">
          <div className="text-center mb-8 sm:mb-10 lg:mb-12">
            ...
            <p
              ...
              data-aos-delay="100"
            >
              Be among the first cabinet makers, manufacturers, and joinery
              workshops to experience CabiPro. Get early access, exclusive
              pricing, and help shape the future of job management for cabinet
