      ...
      <div className="flex min-h-[60vh] items-center justify-center px-4 py-12 sm:py-16 lg:py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-gray-600 px-2">
            Thanks for reaching out, {formData.name}. We&apos;ve received your
      ...
      <section className="bg-white px-4 pt-24 pb-12 sm:px-6 sm:py-20 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            Have questions about CabiPro? We&apos;d love to hear from you. Send
            us a message and we&apos;ll respond as soon as possible. Contact us
            to book a demo
          </p>
        </div>
      </section>
                ...
                <div className="space-y-5 sm:space-y-6">
                  <div className="flex items-start">
                    <div className="shrink-0">
                      <svg
                        className="h-5 w-5 sm:h-6 sm:w-6 text-gray-400 mt-0.5"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
