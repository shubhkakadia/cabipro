    ...
    <div className="bg-white">
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-700 leading-relaxed mb-12">
            By using CabiPro you agree to this Privacy Policy.
          </p>

          <p className="text-gray-700 leading-relaxed mb-12">
            If you have any questions, we&apos;re here to help: <a href="mailto:shubhkakadia@gmail.com" className="text-gray-900 hover:underline font-medium">shubhkakadia@gmail.com</a>
          </p>

          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">1. What This Policy Covers</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              This policy applies to:
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 ml-4">
              <li>our website</li>
              <li>our SaaS platform (CabiPro)</li>
          ...
          <section className="mb-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">2.1 Information you provide directly</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 ml-4">
              ...
              <li>use features inside the platform</li>
            </ul>
            <p className="text-gray-700 leading-relaxed mb-4">
              We may collect:
            </p>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">2.2 Business data you store in CabiPro</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 ml-4">
              ...
              <li>materials and inventory data</li>
              <li>employee details (e.g., names, job roles)</li>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">2.3 Information collected automatically</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 ml-4">
              ...
              <li>usage and navigation patterns</li>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 ml-4">
              ...
              <li>enhance features and usability</li>
              <li>maintain security</li>
            </ul>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">3. Why We Collect Your Information</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              We collect and use information to:
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 ml-4">
              <li>create and manage accounts</li>
              <li>provide and maintain access to CabiPro</li>
              <li>improve the reliability and performance of our services</li>
              <li>communicate about updates, changes, or service issues</li>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">4. Cookies & Tracking Tools</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">5. How We Protect Your Data</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 ml-4">
              ...
              <li>restricted, role-based system access</li>
              <li>periodic security reviews</li>
              <li>data backups and redundancy</li>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">6. Notifiable Data Breaches (NDB Scheme)</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">7. Sharing Your Information</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 ml-4">
              ...
              <li>preventing fraud or wrongdoing</li>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">8. Overseas Transfers</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 ml-4">
              ...
              <li>handle it in line with the Australian Privacy Principles.</li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">10. Your Rights Under Australian Privacy Law</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">11. Marketing Communications</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">13. Links to Third-Party Sites</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">14. Changes to This Privacy Policy</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
