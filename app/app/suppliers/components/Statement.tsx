...
export default function Statement({ supplierId }: StatementProps) {
  ...
  const handleEditStatement = (statement: Statement) => {
    ...
    setStatementForm({
      ...
      due_date: dueDate,
      amount: statement.amount ? String(statement.amount) : "",
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setStatementForm({
                        ...statementForm,
                        payment_status: e.target.value as "PENDING" | "PAID",
                      })
                    }
                    className="w-full px-4 py-3 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none"
                  >
