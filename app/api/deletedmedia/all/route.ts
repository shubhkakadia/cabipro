...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const processFileDeletion = async (filename: string) => {
      try {
        ...
        let deletedMedia:
          | Awaited<ReturnType<typeof prisma.lot_file.findFirst>>
          | Awaited<ReturnType<typeof prisma.media.findFirst>>
          | Awaited<ReturnType<typeof prisma.supplier_file.findFirst>> = null;

        let tableName = "lot_file";

        deletedMedia = await prisma.lot_file.findFirst({
          where: {
