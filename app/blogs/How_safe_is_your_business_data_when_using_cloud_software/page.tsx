...
export const metadata: Metadata = {
  title: "How Safe Is Your Business Data When Using Cloud Software? - CabiPro",
  description: "Learn about cloud security, the shared responsibility model, and how to vet cloud software providers to keep your business data safe.",
};
      ...
      <div className="mx-auto max-w-4xl px-4 pt-24 pb-12 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
        ...
        <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none">
                  ...
                  <tbody className="bg-white divide-y divide-gray-300">
                    <tr>
                      ...
                      <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 md:px-4 md:py-3 text-gray-700">
                        High. Armed guards, biometrics, disaster-proof buildings.
                      </td>
                      <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 md:px-4 md:py-3 text-gray-700">
                        Low. Often a locked closet or under a desk; vulnerable to break-ins/fire.
                      </td>
                    </tr>
                    <tr className="bg-gray-50">
                      ...
                      <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 md:px-4 md:py-3 text-gray-700">
                        Manual. Requires your IT staff to schedule and install updates (often delayed).
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 md:px-4 md:py-3 font-medium text-gray-900 whitespace-nowrap">
                      ...
                      <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 md:px-4 md:py-3 text-gray-700">
                        Redundant. Data is often mirrored across multiple locations.
                      </td>
                      <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 md:px-4 md:py-3 text-gray-700">
                        Single Point of Failure. If the server breaks or backup drive fails, data is lost.
                      </td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 md:px-4 md:py-3 font-medium text-gray-900 whitespace-nowrap">
                      ...
                      <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 md:px-4 md:py-3 text-gray-700">
                        Account Hijacking. Hackers try to steal login credentials.
                      </td>
                      <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 md:px-4 md:py-3 text-gray-700">
                        Ransomware. Hackers encrypt your local network and demand payment.
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <section className="mb-6 sm:mb-8 md:mb-10 lg:mb-12">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 space-y-1 sm:space-y-1.5 md:space-y-2 mb-2 sm:mb-3 md:mb-4 ml-2 sm:ml-3 md:ml-4">
              <li>
                <strong>At Rest:</strong> Is data scrambled when it sits on their servers?
              </li>
              <li>
                <strong>In Transit:</strong> Is data scrambled when it travels from their server to your computer? (Look for the HTTPS lock icon).
              </li>
            </ul>
        ...
        <div className="mt-8 sm:mt-12 md:mt-16 lg:mt-20 rounded-xl sm:rounded-2xl bg-gray-900 px-4 py-8 sm:px-6 sm:py-10 md:px-8 md:py-12 lg:px-12 lg:py-16 text-center" data-aos="fade-up">
          ...
          <p className="mx-auto max-w-2xl text-sm sm:text-base md:text-lg text-gray-300 mb-4 sm:mb-6 md:mb-8 leading-relaxed px-2">
            CabiPro is built with security in mind. Join the waitlist to get early access to a job management platform designed specifically for cabinet manufacturers, with enterprise-grade security and data protection.
          </p>
