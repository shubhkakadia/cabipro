...
export const metadata: Metadata = {
  ...
  description: "Learn proven strategies for material management and waste reduction in cabinet making. Discover cutting optimization techniques, inventory management tips, and cost-saving practices for cabinet makers and joinery workshops.",
};
      ...
      <div className="mx-auto max-w-4xl px-4 pt-24 pb-12 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
        ...
        <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none">
          ...
          <section className="mb-6 sm:mb-8 md:mb-10 lg:mb-12">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 space-y-1 sm:space-y-1.5 md:space-y-2 mb-2 sm:mb-3 md:mb-4 ml-2 sm:ml-3 md:ml-4">
              <li><strong>Component dimensions</strong> — Exact sizes for every panel, door, and drawer component</li>
              <li><strong>Material specifications</strong> — Board type, finish, thickness, and grade</li>
              <li><strong>Quantities with waste factors</strong> — Account for cutting waste and inevitable mistakes</li>
              <li><strong>Hardware and accessories</strong> — Hinges, handles, drawer runners, and other components</li>
            </ul>
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 space-y-1 sm:space-y-1.5 md:space-y-2 mb-2 sm:mb-3 md:mb-4 ml-2 sm:ml-3 md:ml-4">
              <li>Standard board sizes from your suppliers (e.g., Polytec, Laminex, Acrilam in Australia)</li>
          ...
          <section className="mb-6 sm:mb-8 md:mb-10 lg:mb-12">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 space-y-1 sm:space-y-1.5 md:space-y-2 mb-2 sm:mb-3 md:mb-4 ml-2 sm:ml-3 md:ml-4">
              <li><strong>5-8% waste factor</strong> for simple, repetitive cuts on standard panels</li>
              <li><strong>10-15% waste factor</strong> for complex jobs with many different components</li>
              <li><strong>15-20% waste factor</strong> for custom jobs with irregular shapes or special finishes</li>
            </ul>
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
          ...
          <section className="mb-6 sm:mb-8 md:mb-10 lg:mb-12">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 space-y-1 sm:space-y-1.5 md:space-y-2 mb-2 sm:mb-3 md:mb-4 ml-2 sm:ml-3 md:ml-4">
              <li>Keeping offcuts larger than a minimum usable size (e.g., 300mm x 300mm)</li>
              <li>Organizing by material type and finish for easy searching</li>
              <li>Using offcuts for smaller components like drawer bottoms, backs, or internal panels</li>
              <li>Regularly auditing and disposing of offcuts that have been unused for extended periods</li>
            </ul>
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
          ...
          <section className="mb-6 sm:mb-8 md:mb-10 lg:mb-12">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 space-y-1 sm:space-y-1.5 md:space-y-2 mb-2 sm:mb-3 md:mb-4 ml-2 sm:ml-3 md:ml-4">
              <li>Grouping similar jobs together to reduce machine setup changes</li>
              ...
              <li>Training staff on proper setup procedures to reduce errors</li>
            </ul>
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 space-y-1 sm:space-y-1.5 md:space-y-2 mb-2 sm:mb-3 md:mb-4 ml-2 sm:ml-3 md:ml-4">
              <li>Material usage tracking — Recording what&apos;s used, added, and wasted for each job</li>
              <li>Waste cost analysis — Calculating the dollar value of waste materials</li>
              <li>Job-by-job waste percentages — Identifying which types of jobs produce the most waste</li>
              <li>Regular waste audits — Periodically reviewing offcut storage and disposal</li>
            </ul>
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
          ...
          <section className="mb-6 sm:mb-8 md:mb-10 lg:mb-12">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 space-y-1 sm:space-y-1.5 md:space-y-2 mb-2 sm:mb-3 md:mb-4 ml-2 sm:ml-3 md:ml-4">
              ...
              <li>Integration with cutting optimization and nesting software</li>
              <li>Real-time inventory tracking and material-to-order planning</li>
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 space-y-1 sm:space-y-1.5 md:space-y-2 mb-2 sm:mb-3 md:mb-4 ml-2 sm:ml-3 md:ml-4">
              <li>Automatically generating optimized cutting programs from job data</li>
              <li>Minimizing tool changes and setup time</li>
              <li>Ensuring precise cuts that match design specifications exactly</li>
          ...
          <section className="mb-6 sm:mb-8 md:mb-10 lg:mb-12">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 space-y-1 sm:space-y-1.5 md:space-y-2 mb-2 sm:mb-3 md:mb-4 ml-2 sm:ml-3 md:ml-4">
              <li><strong>Plan before cutting:</strong> Always create optimized cutting layouts before starting production</li>
              <li><strong>Batch similar jobs:</strong> Combine multiple jobs with similar materials to maximize sheet usage</li>
              <li><strong>Maintain accurate inventory:</strong> Know what you have in stock before ordering new materials</li>
              <li><strong>Track everything:</strong> Record material usage and waste for every job to identify improvement opportunities</li>
              <li><strong>Train your team:</strong> Ensure all staff understand waste reduction goals and techniques</li>
              <li><strong>Regular audits:</strong> Periodically review waste patterns and adjust processes accordingly</li>
              <li><strong>Use technology:</strong> Leverage software tools for material management and cutting optimization</li>
              <li><strong>Standardize where possible:</strong> Offer standard component sizes that work across multiple jobs</li>
            </ul>
          </section>
          ...
          <section className="mb-6 sm:mb-8 md:mb-10 lg:mb-12">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 space-y-1 sm:space-y-1.5 md:space-y-2 mb-2 sm:mb-3 md:mb-4 ml-2 sm:ml-3 md:ml-4">
              <li>If you spend $100,000 annually on materials, reducing waste from 15% to 10% saves $5,000</li>
              <li>That savings goes directly to your bottom line</li>
              <li>Over 5 years, that&apos;s $25,000 — often enough to justify investing in better tools and systems</li>
            </ul>
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-2 sm:mb-3 md:mb-4">
        ...
        <div className="mt-8 sm:mt-12 md:mt-16 lg:mt-20 rounded-xl sm:rounded-2xl bg-gray-900 px-4 py-8 sm:px-6 sm:py-10 md:px-8 md:py-12 lg:px-12 lg:py-16 text-center" data-aos="fade-up">
          ...
          <p className="mx-auto max-w-2xl text-sm sm:text-base md:text-lg text-gray-300 mb-4 sm:mb-6 md:mb-8 leading-relaxed px-2">
            CabiPro helps cabinet makers and joinery workshops track materials, manage inventory, and reduce waste. Join the waitlist to get early access to material management tools built specifically for your industry.
          </p>
